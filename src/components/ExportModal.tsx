...
import { detectGpuCapabilities, GpuCapabilities } from '../utils/gpuExportEngine';
            ...
            <div className="p-4 border-b border-[#262626] flex items-center justify-between bg-[#0D0D0D]">
              ...
              <div className="flex items-center gap-5">
                ...
                <button
                  ...
                  className={`text-xs font-semibold pb-1 tracking-tight transition-colors relative cursor-pointer flex items-center gap-1.5 ${
                    activeTab === '3d' ? 'text-white' : 'text-[#737373] hover:text-[#ECECEC]'
                  }`}
                >
                  <span>3D MODEL</span>
                  {activeTab === '3d' && (
              ...
              <div className="flex items-center gap-2">
                <div
                  title="GPU Pipeline: WebGL2 + WebCodecs Accelerated"
                  className="hidden sm:flex items-center gap-1 px-2 py-0.5 rounded-full bg-[#181818] border border-[#2E2E2E] text-[10px] text-emerald-400 font-mono"
                >
          ...
          <div className="p-5 space-y-4 text-xs">
            ...
            {!isPro && (
              <div className="px-3.5 py-2.5 rounded-lg bg-[#181818] border border-[#262626] flex items-center justify-between text-xs">
                <div className="flex items-center gap-2 text-[#D4D4D4]">
                  <Lock className="w-3.5 h-3.5 text-[#da0a2c] shrink-0" />
                  <span>Fitur export 3D Model dikunci</span>
                </div>
                <div className="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-[#262626] text-[#A3A3A3] text-[10px]">
                  <Crown className="w-3 h-3 text-[#EAB308]" />
                  <span>Pro Plan</span>
                </div>
              </div>
            )}
            ...
            {/* Model Card Info */}
            <div className="p-3.5 rounded-xl bg-[#181818] border border-[#262626] space-y-3">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-[#222222] border border-[#333333] flex items-center justify-center shrink-0">
                  <Box className="w-5 h-5 text-white" />
                </div>
                <div className="flex-1 min-w-0">
                  <h4 className="text-sm font-semibold text-white truncate">{currentModel.name}</h4>
                  <p className="text-[11px] text-[#888888]">glTF 2.0 Binary Format (.glb)</p>
                </div>
                <span className="px-2 py-0.5 text-[10px] font-mono bg-[#262626] text-emerald-400 border border-emerald-950 rounded">
                  PBR Ready
                </span>
              </div>

              <div className="pt-2 border-t border-[#262626] grid grid-cols-2 gap-2 text-[11px]">
                <div className="flex flex-col gap-0.5">
                  <span className="text-[#737373]">Texture Resolution</span>
                  <span className="text-white font-medium">4096 × 4096 px (4K)</span>
                </div>
                <div className="flex flex-col gap-0.5">
                  <span className="text-[#737373]">PBR Materials</span>
                  <span className="text-white font-medium">Color, Roughness, Metal</span>
                </div>
                <div className="flex flex-col gap-0.5">
                  <span className="text-[#737373]">UV Coordinates</span>
                  <span className="text-white font-medium">Preserved & Baked</span>
                </div>
                <div className="flex flex-col gap-0.5">
                  <span className="text-[#737373]">Color Space</span>
                  <span className="text-white font-medium">sRGB Standard</span>
                </div>
              </div>
            </div>

            {/* Compatibility pill */}
            <div className="p-2.5 rounded-lg bg-[#141414] border border-[#262626] text-[11px] text-[#A3A3A3] flex items-center justify-between">
              <span>Compatible Software:</span>
              <span className="text-white font-mono text-[10px]">Blender • CLO 3D • Unity • Unreal</span>
            </div>
                ...
                <>
                  ...
                  {onDownloadSVG && (
                    <button
                      ...
                      className="w-full py-2 rounded-lg bg-[#1A1A1A] hover:bg-[#262626] text-[#D4D4D4] hover:text-white border border-[#333333] transition-colors flex items-center justify-center gap-2 cursor-pointer text-xs active:scale-98"
                    >
                      <Layers className="w-3.5 h-3.5" />
                      <span>Download UV Pattern (.SVG)</span>
                    </button>
                  )}
                </>
              )}
